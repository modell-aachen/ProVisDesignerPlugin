...
SCRIPT
  ...
  Foswiki::Func::addToZone(
    ...
    $script,
    "PROVISDESIGNER::PRINT::SCRIPT,JQUERYPLUGIN::FOSWIKI::PREFERENCES" );
...
sub _DRAWING {
  ...
  if ($drawingRevision != 0) {
    ...
    $imgParams = {
      src => "%PUBURL%/%SYSTEMWEB%/CKEditorPlugin/$ckePath/plugins/qwikiprovis/images/placeholder_$drawingType.png",
